...
import com.manmohan.pocai.aiengine.classifiers.FaceRecognitionClassifier2;
...
public class TrainFaceRecognition extends CameraActivity implements ImageReader.OnImageAvailableListener {
    ...
    private FaceRecognitionClassifier2 faceClassifier;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        AlertDialog editDialog = new AlertDialog.Builder(TrainFaceRecognition.this)
                .setTitle(R.string.enter_name)
                .setView(dialogView)
                .setPositiveButton(getString(R.string.ok), (dialogInterface, i) -> {
                    int idx = faceClassifier.addPerson(editText.getText().toString());
        ...
        button.setOnClickListener(view ->
                new AlertDialog.Builder(TrainFaceRecognition.this)
                        .setTitle(getString(R.string.select_name))
                        .setItems(faceClassifier.getClassNames(), (dialogInterface, i) -> {
                            if (i == 0) {
                                editDialog.show();
                            } else {
    ...
    void init() {
        ...
        try {
            faceClassifier = FaceRecognitionClassifier2.getInstance(getAssets(), FACE_SIZE, FACE_SIZE);
        } catch (Exception e) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            new Thread(() -> {
                try {
                    faceClassifier.updateData(requestCode, getContentResolver(), uris);
                } catch (Exception e) {
                    e.printStackTrace();
